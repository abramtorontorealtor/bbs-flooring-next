      ...
      <main className="max-w-4xl mx-auto px-4 py-16 space-y-20">
        ...
        <section id="head-to-head">
          ...
          <div className="overflow-x-auto rounded-xl border border-stone-200">
            <table className="w-full text-sm">
              ...
              <tbody>
                {[
                  ['Price at BBS', '$3.00–$8.99/sqft', '$5.10–$7.59/sqft', '$2.19–$4.35/sqft', '$1.49–$3.39/sqft'],
        ...
        <section id="engineered-hardwood">
          ...
          <div className="flex gap-3 mb-4">
            ...
            <span className="text-stone-400 text-sm mt-0.5">$3.00–$8.99/sqft · Avg $5.02/sqft</span>
          </div>
          ...
          <p className="text-stone-600 leading-relaxed mb-6">
            BBS stocks 600+ engineered hardwood products from 10 brands: Vidar (240, call for pricing), NAF (89), Northernest (71), Woden (51), Canadian Standard (48), Impressive (47), Simba (46), Falcon (25), BBS Reserve (18, our house brand), and Triforest (12). Species range from White Oak and Hickory to American Oak, Walnut, and Maple. Common widths are 6½" and 7½" — with wide plank (7"+) dominating 2026 sales.
          </p>
          <p className="text-stone-600 leading-relaxed mb-6">
            A popular entry point is the{' '}
            <Link href="/products/don-valley-bbs-reserve-select-better-engineered-american-oak-hardwood-flooring" className="text-amber-700 underline hover:text-amber-800">Don Valley by BBS Reserve</Link>
        ...
        <section id="vinyl">
          ...
          <p className="text-stone-600 leading-relaxed mb-6">
            BBS stocks 340+ vinyl options from 8 brands: NAF (128, $2.29–$4.29/sqft), Triforest (90, $2.29–$3.99/sqft), Woden (49, $2.39–$4.35/sqft), Impressive (48, $1.79–$2.89/sqft), Simba (42, $1.99–$3.59/sqft), Falcon (19, $1.69–$2.59/sqft), BBS Reserve (10, our house brand, call for pricing), and Vidar (7, call for pricing). Wear layers range from 12mil to 28mil, with click-lock installation standard across all products.
          </p>
          <p className="text-stone-600 leading-relaxed mb-6">
        ...
        <section id="best-for-room">
          ...
          <div className="space-y-4">
            {[
              ['🏠 Living Room', 'Engineered Hardwood', 'The living room is where you see the most flooring and where resale value matters most. White Oak in 6½"–7½" wide-plank with a matte finish is the 2026 standard. From $3.00/sqft at BBS.'],
        ...
        <section id="cost-comparison">
          ...
          <div className="overflow-x-auto rounded-xl border border-stone-200">
            <table className="w-full text-sm">
              ...
              <tbody>
                {[
                  ['Engineered Hardwood', 'Budget', '$3.00–$3.99', '$2.25', '$5.25–$6.24', '$2,625–$3,120'],
                  ...
                  ['Laminate', 'Premium', '$2.89–$3.39', '$2.00', '$4.89–$5.39', '$2,445–$2,695'],
          ...
          <div className="space-y-6">
            {[
              ['1. What&apos;s your budget per square foot (material only)?', [
                ...
                ['$2.50–$5.00/sqft', '→ Vinyl ($1.79–$3.59) or budget engineered hardwood ($3.00–$4.99)'],
        ...
        <section className="bg-gradient-to-br from-stone-900 to-amber-900 text-white rounded-2xl p-10 text-center">
          ...
          <p className="text-stone-300 text-lg mb-8 max-w-2xl mx-auto">
            BBS Flooring stocks 900+ options across hardwood, vinyl, and laminate — starting at $1.49/sqft. Visit our Markham showroom, get a free quote, or book a free in-home measurement.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
