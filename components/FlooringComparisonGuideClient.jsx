    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-4 py-16 space-y-20">
        ...
        <section id="vinyl">
          ...
          <p className="text-stone-600 leading-relaxed mb-6">
            BBS stocks 340+ vinyl options from 8 brands: NAF (128, $2.29–$4.29/sqft), Triforest (90, $2.29–$3.99/sqft), Woden (49, $2.39–$4.35/sqft), Impressive (48, $1.79–$2.89/sqft), Simba (42, $1.99–$3.59/sqft), Falcon (19, $1.69–$2.59/sqft), BBS Reserve (10, our house brand, $1.79/sqft), and Vidar (7, call for pricing). Wear layers range from 12mil to 28mil, with click-lock installation standard across all products.
          </p>
          <p className="text-stone-600 leading-relaxed mb-6">
