        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="https://www.facebook.com/bbsfloorsto" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-slate-400 hover:text-blue-500 transition-colors text-sm">
              ...
              <li>
                <a href="https://www.instagram.com/bbsfloors" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-slate-400 hover:text-pink-500 transition-colors text-sm">
