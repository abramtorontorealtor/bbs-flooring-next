  ...
  return (
    <div className="mt-12 mb-8">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {links.map(({ route, href, label, description }) => (
          <Link key={route || href} href={href || createPageUrl(route)} className="group flex items-start gap-3 bg-gradient-to-br from-amber-50 to-slate-50 hover:from-amber-100 hover:to-slate-100 border border-slate-200 hover:border-amber-300 rounded-xl p-5 transition-all">
