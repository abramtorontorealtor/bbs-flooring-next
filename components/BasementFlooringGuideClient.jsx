            ...
            <div className="border border-stone-200 rounded-xl p-6">
              ...
              <div className="bg-stone-50 rounded-lg p-4">
                ...
                <p className="text-stone-600 text-sm">
                  ...
                  <Link href="/products/uxbridge-bbs-reserve-vinyl-flooring" className="text-amber-700 underline hover:text-amber-800">BBS Reserve Uxbridge 7mm</Link>{' '}
