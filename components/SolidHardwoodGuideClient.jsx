            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-200">
                ...
                <tr>
                  ...
                  <td className="p-3 text-slate-600 font-medium">$3.00–$8.99/sqft</td>
                </tr>
                <tr className="bg-slate-50">
