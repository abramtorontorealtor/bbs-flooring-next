  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-4xl mx-auto px-4 py-16">
          ...
          <table className="w-full text-sm text-left border-collapse min-w-[560px]">
            ...
            <tbody className="divide-y divide-slate-200">
              {[
                ...
                ['Warranty on the work', '2-year workmanship warranty on every install, plus the manufacturer\'s product warranty', 'Installer\'s terms vary by contractor', 'Product warranty only — no one warrants the install'],
        ...
        <p className="text-slate-700 max-w-3xl mx-auto mt-6 leading-relaxed">
          <strong>The short answer to &ldquo;why not Home Depot?&rdquo;:</strong> BBS Flooring buys direct from the manufacturers and sells at wholesale prices from a 1,000+ floor showroom in Markham, then installs with its own WSIB-insured crews under a 2-year workmanship warranty. A big-box store sells the box at retail and hands the install to a third party; an online seller hands you the box and nothing else. Same brand and product for less at another local store? We beat it.
        </p>
        <p className="text-xs text-slate-500 text-center mt-3">
          General comparison of retail models; individual stores and sellers vary.
        </p>
      </section>
