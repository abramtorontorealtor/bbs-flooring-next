 ...
 *
 * Notice: showroom closed Mon September 21, 2026.
 *
 * Self-expiring: only renders through end of day September 21, 2026 America/Toronto.
...
// Show through 2026-09-22 04:00 UTC == 2026-09-22 00:00 ET (end of Sep 21 ET).
const EXPIRES_AT = Date.parse('2026-09-22T04:00:00Z');
const DISMISS_KEY = 'bbs-closure-2026-09-21-dismissed';
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-sm rounded-2xl bg-white p-6 text-center shadow-2xl">
        ...
        <p className="mt-1 text-sm font-medium text-amber-700">Monday, September&nbsp;21</p>
