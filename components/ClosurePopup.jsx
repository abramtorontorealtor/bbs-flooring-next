 ...
 *
 * Notice: showroom closed Fri September 4, 2026.
 *
 * Self-expiring: only renders through end of day September 4, 2026 America/Toronto.
...
// Show through 2026-09-05 04:00 UTC == 2026-09-05 00:00 ET (end of Sep 4 ET).
const EXPIRES_AT = Date.parse('2026-09-05T04:00:00Z');
const DISMISS_KEY = 'bbs-closure-2026-09-04-dismissed';
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-sm rounded-2xl bg-white p-6 text-center shadow-2xl">
        ...
        <p className="mt-1 text-sm font-medium text-amber-700">Friday, September&nbsp;4</p>
