    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
        <div>
          ...
          <p className="text-slate-600 mb-4 leading-relaxed">
            Located on Highway 7 in Markham, our showroom carries over 1,000 products — from solid and engineered hardwood to luxury vinyl plank, laminate, and everything in between.
          </p>
