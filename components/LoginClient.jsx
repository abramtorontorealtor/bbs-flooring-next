    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link href="/forgot-password" className="text-xs text-amber-600 hover:text-amber-700 font-medium">Forgot password?</Link>
              </div>
              <div className="relative">
        ...
        <p className="text-center text-sm text-slate-500 mt-6">
          ...
          <Link href="/signup" className="text-amber-600 hover:text-amber-700 font-semibold">Create one</Link>
        </p>
      </div>
    </div>
  );
