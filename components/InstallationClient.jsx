...
const HERO_IMAGE = `${CDN_GALLERY}/flooring-project-1.webp`;
...
const SERVICES = [
  { title: 'Floor Installation', desc: 'Hardwood, vinyl, laminate & tile — expert installation with furniture moving included.', price: 'From $2.00/sqft', href: '#pricing', emoji: '🏠' },
  ...
  return (
    <div className="bg-white">
      ...
      <ServiceHero
        ...
        titleLine1="Professional Flooring"
        titleLine2="Installation Services"
        subtitle="From hardwood to vinyl, laminate to tile — BBS Flooring delivers expert installation across Markham, Toronto, Durham & the GTA. Transparent pricing. No hidden fees."
        pricingPills={[
      ...
      {/* ─── Process Stepper (custom — horizontal on desktop, vertical on mobile) ─── */}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            {pricingData.map((item, i) => (
              <div key={i} className="flex items-center justify-between bg-white border border-slate-200 rounded-xl px-5 py-4 hover:border-amber-300 transition-colors">
                <div>
      ...
      {/* ─── Project Gallery (8 images, 4-col) ─── */}
      <section className="py-12 md:py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <ServiceAreaPills
        title="Service Area"
        subtitle="Professional flooring installation across the Greater Toronto Area."
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12 md:pt-10 md:pb-16">
        ...
        <SpokeLinks title="Explore Our Installation & Related Services" links={INSTALLATION_SPOKE_LINKS} />

        {/* ─── Final CTA ─── */}
        <FinalCTA
          title="Ready to Transform Your Space?"
          subtitle="Book your free in-home measurement and get a detailed, no-obligation quote within 24 hours."
          primaryCTA={{ text: 'Schedule Free Measurement', route: 'FreeMeasurement' }}
        />
      </div>
