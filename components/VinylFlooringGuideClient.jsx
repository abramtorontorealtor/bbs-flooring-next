          ...
          <div className="overflow-x-auto mb-6">
            <table className="w-full border-collapse text-sm">
              ...
              <tbody className="text-slate-600">
                ...
                <tr className="border-b bg-slate-50"><td className="p-3 font-medium">Material cost (BBS)</td><td className="p-3 text-center">$1.79–$3.59</td><td className="p-3 text-center">$3.29–$8.99</td><td className="p-3 text-center">$1.49–$2.99</td></tr>
