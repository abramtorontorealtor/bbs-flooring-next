          ...
          <div className="mb-1.5">
            {hidePrice ? (
              <div className="flex items-center gap-1.5 flex-wrap">
                ...
                {/* Channel micro-buttons */}
                <div className="flex gap-1 ml-auto">
                  <a href={callUrl()} aria-label="Call us" onClick={e => e.stopPropagation()}
                  ...
                  <a href={smsUrl(product.name)} aria-label="Text us" onClick={e => e.stopPropagation()}
                    className="w-6 h-6 rounded-md bg-slate-100 hover:bg-slate-200 flex items-center justify-center transition-colors">
                  ...
                  <a href={whatsappUrl(product.name)} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" onClick={e => e.stopPropagation()}
