...
export const BRAND_PAGES = {
  ...
  'BBS Reserve': { label: 'BBS Reserve', url: '/bbs-reserve' },
...
export const STATIC_BREADCRUMBS = {
  ...
  '/bbs-reserve':                 [HOME, { label: 'BBS Reserve' }],
  ...
  '/contractor-flooring':         [HOME, { label: 'Contractor & Trade Program' }],
  ...
  '/hardwood-removal':          [HOME, { label: 'Hardwood Removal' }],
  '/tile-removal':              [HOME, { label: 'Tile Removal' }],
  '/vinyl-laminate-removal':    [HOME, { label: 'Vinyl & Laminate Removal' }],
  '/carpet-to-hardwood-stairs': [HOME, { label: 'Carpet to Hardwood Stairs' }],
  '/carpet-to-hardwood-stairs-richmond-hill': [HOME, { label: 'Carpet to Hardwood Stairs', url: '/carpet-to-hardwood-stairs' }, { label: 'Richmond Hill' }],
  '/carpet-to-hardwood-stairs-vaughan':       [HOME, { label: 'Carpet to Hardwood Stairs', url: '/carpet-to-hardwood-stairs' }, { label: 'Vaughan' }],
  '/carpet-to-hardwood-stairs-scarborough':   [HOME, { label: 'Carpet to Hardwood Stairs', url: '/carpet-to-hardwood-stairs' }, { label: 'Scarborough' }],
  '/carpet-to-hardwood-stairs-oakville':      [HOME, { label: 'Carpet to Hardwood Stairs', url: '/carpet-to-hardwood-stairs' }, { label: 'Oakville' }],
  '/stair-recapping':           [HOME, { label: 'Stair Recapping' }],
  '/stair-recapping-markham':      [HOME, { label: 'Stair Recapping', url: '/stair-recapping' }, { label: 'Markham' }],
  '/stair-recapping-richmond-hill': [HOME, { label: 'Stair Recapping', url: '/stair-recapping' }, { label: 'Richmond Hill' }],
  '/stair-recapping-vaughan':      [HOME, { label: 'Stair Recapping', url: '/stair-recapping' }, { label: 'Vaughan' }],
  '/stair-refinishing-markham':    [HOME, { label: 'Stair Refinishing', url: '/stair-refinishing' }, { label: 'Markham' }],
  '/stair-refinishing-vaughan':    [HOME, { label: 'Stair Refinishing', url: '/stair-refinishing' }, { label: 'Vaughan' }],
  '/stair-refinishing-pickering':  [HOME, { label: 'Stair Refinishing', url: '/stair-refinishing' }, { label: 'Pickering' }],
  '/stair-renovation-markham':     [HOME, { label: 'Stair Renovation', url: '/stairs' }, { label: 'Markham' }],
  '/free-measurement':          [HOME, { label: 'Free Measurement' }],
  '/flooring-installation-cost':[HOME, { label: 'Installation Cost Guide' }],
  ...
  '/floor-finder':              [HOME, { label: 'Floor Finder' }],
...
/**
 * Build breadcrumb items for a city × product type page.
 * Home > Product Type > City
 */
export function getCityProductBreadcrumbs(productLabel, productUrl, cityName) {
  return [HOME, { label: productLabel, url: productUrl }, { label: cityName }];
}
