...
// Every key the recommender can reference — the server page passes ONLY these
// items to the client so the RSC payload doesn't scale with the catalogue (S5).
export const CALCULATOR_KEYS = ['AR630-04', 'ARH695-04', 'ARP4-04', 'Q70115', 'prosol_eco983', 'prosol_wax_paper', 'underpad_2_5_white', 'underpad_3_black', 'underpad_5_airflow'];
