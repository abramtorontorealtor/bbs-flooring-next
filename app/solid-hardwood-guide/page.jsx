...
const faqItems = [
  ...
  },
  {
    ...
    answer: 'No. Solid hardwood should never be installed below grade (basements). Wood absorbs moisture from concrete subfloors, causing cupping, buckling, and warping. For basements, use engineered hardwood (from $3.00/sqft) or waterproof vinyl (from $2.19/sqft, $1.79 on clearance) — both available at BBS Flooring.',
  },
  {
