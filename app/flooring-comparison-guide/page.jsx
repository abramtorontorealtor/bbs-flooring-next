...
const faqItems = [
  ...
  },
  {
    ...
    answer: 'Vinyl offers the best upfront value at $1.79–$3.59/sqft material + $2.00/sqft installation. Hardwood costs more upfront ($3.00–$8.99/sqft for engineered) but adds more resale value and lasts longer. For a 500 sqft room, vinyl costs $2,095–$3,175 installed vs $2,770–$6,120 for engineered hardwood.',
  },
  {
    question: 'What is the cheapest flooring option at BBS?',
    answer: 'Laminate flooring starts at $1.49/sqft (Tosca Floors). With installation at $2.00/sqft, total cost starts around $3.49/sqft — about $1,745 for a 500 sqft room. Vinyl starts at $1.79/sqft, making it the second most affordable option.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Vinyl (LVP/SPC) is the top choice for rentals — waterproof, durable, affordable ($1.79–$3.59/sqft), and tenants can\'t easily damage it. Laminate ($1.49–$3.29/sqft) is the budget alternative. Avoid expensive hardwood in rental units unless targeting premium tenants.',
  },
  {
